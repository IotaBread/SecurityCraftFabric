...
public class MotionActivatedLightTileEntity extends CustomizableTileEntity {
	...
	private DoubleOption searchRadiusOption = new DoubleOption("searchRadius", ConfigHandler.CONFIG.motionActivatedLightSearchRadius, 5.0D, 20.0D, 5.0D);
	...
	public boolean attackEntity(Entity entity) {
		...
		else if(entity instanceof LivingEntity && BlockUtils.getBlock(getWorld(), pos) == SCContent.MOTION_ACTIVATED_LIGHT)
	...
	public void attackFailed() {
		if(BlockUtils.getBlock(getWorld(), pos) == SCContent.MOTION_ACTIVATED_LIGHT && BlockUtils.getBlockProperty(getWorld(), getPos(), MotionActivatedLightBlock.LIT))
			MotionActivatedLightBlock.toggleLight(world, pos, getOwner(), false);
	}
