...
//	@Override
	 ...
	 */
	public default DefaultedList<ItemStack> readModuleInventory(CompoundTag tag)
	{
		ListTag list = tag.getList("Modules", NbtType.COMPOUND);
		...
		for(int i = 0; i < list.size(); ++i)
		{
			...
			if(slot >= 0 && slot < modules.size())
				modules.set(slot, ItemStack.fromTag(stackTag));
		}
